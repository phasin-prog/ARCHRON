...
export function Tooltip({
  ...
  return (
    <span className={`group/tt relative inline-flex items-center ${className}`}>
      ...
      <span
        role="tooltip"
        className={`pointer-events-none absolute bottom-full left-1/2 z-50 mb-2 w-max max-w-[240px] -translate-x-1/2 whitespace-normal rounded-md border border-ink/12 bg-surface-container px-3 py-2 text-left text-xs font-normal normal-case leading-relaxed tracking-normal text-on-surface-variant shadow-[0_12px_30px_-12px_rgba(0,0,0,0.7)] transition-opacity duration-200 ${
