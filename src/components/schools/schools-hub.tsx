...
import { EN_LETTERS, THAI_LETTERS, type School } from "@/lib/content/core/seeds/schools";
            ...
            {filtered.map((s) => {
              ...
              return (
                <Link
                  ...
                  style={{
                    background: `linear-gradient(160deg, color-mix(in srgb, ${meta.accent} 7%, var(--color-bg-card)) 0%, var(--color-bg-card) 100%)`,
                  }}
                >
                  <div>
