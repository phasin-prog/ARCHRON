...
export function EditorCta({ draft, updateField }: {
  ...
  return (
    <section className="space-y-4 border-t border-border pt-6">
      ...
      <div>
        <label title="Article Slugs" className="block text-sm font-medium text-text-body">Article Slugs (คั่นด้วย ,)</label>
      ...
      <div>
        <label title="Concept Slugs" className="block text-sm font-medium text-text-body">Concept Slugs (คั่นด้วย ,)</label>
      ...
      <div>
        <label title="Reading Set Slugs" className="block text-sm font-medium text-text-body">Reading Set Slugs (คั่นด้วย ,)</label>
