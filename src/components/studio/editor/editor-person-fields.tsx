...
export function EditorPersonFields({
  ...
  return (
    <section className="space-y-4 border-t border-border pt-6">
      <h2 className="font-serif text-lg font-semibold text-text-heading">ข้อมูลนักคิดและคุณูปการทางวิชาการ</h2>
      <div className="grid grid-cols-2 gap-4">
        <div>
          <label title="ปีเกิด (Birth Year)" className="block text-sm font-medium text-text-body">ปีเกิด</label>
        ...
        <div>
          <label title="ปีเสียชีวิต (Death Year)" className="block text-sm font-medium text-text-body">ปีเสียชีวิต</label>
      ...
      <div>
        <label title="สัญชาติ (Nationality)" className="block text-sm font-medium text-text-body">สัญชาติ</label>
      ...
      <div id="container-field-technical-meaning" className="rounded-lg transition-all duration-300">
        <label htmlFor="field-technical-meaning" title="ความหมายทางวิชาการ/บทบาท (Technical Role)" className="block text-sm font-medium text-text-body">
          ความหมายทางวิชาการ / บทบาทต่อสาขาวิชา
        </label>
      ...
      <div>
        <label title="แนวคิดสำคัญ (Key Ideas/Contributions)" className="block text-sm font-medium text-text-body">แนวคิดสำคัญ (คั่นด้วย ,)</label>
      ...
      <div>
        <label title="ผลงานเด่น (Notable Works)" className="block text-sm font-medium text-text-body">ผลงานเด่น (คั่นด้วย ,)</label>
