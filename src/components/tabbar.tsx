...
export function Tabbar() {
  ...
  return (
    <nav
      ...
      className="fixed inset-x-0 bottom-0 z-40 border-t border-accent/12 pb-[env(safe-area-inset-bottom,0px)] bg-bg/72 backdrop-blur-md max-lg:flex lg:hidden"
    >
        ...
        {ITEMS.map((it, index) => {
          ...
          return (
            <li key={it.href} className="flex-1">
              ...
              >
                <span
                  className={`relative flex h-9 w-12 items-center justify-center rounded-full transition-all duration-300 ${
                    active
                ...
                >
                  ...
                  {tappedIndex === index && (
                    <span
                      className="tab-float pointer-events-none absolute inset-0 rounded-full bg-accent/30"
