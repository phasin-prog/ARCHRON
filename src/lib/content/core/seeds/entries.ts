...
export const entries: DiscriminatedEntry[] = [
...

  {
    ...
    visualExplanation:
      "Individuation ไม่ใช่การพัฒนาตัวเองให้สมบูรณ์แบบ แต่เป็นการค่อย ๆ รับรู้และจัดความสัมพันธ์ระหว่างส่วนต่าง ๆ ของชีวิตภายในอย่างซื่อตรง",
    technicalMeaning:
...

  {
    ...
    visualExplanation:
      "Carl Jung (1875-1961) เป็นผู้พัฒนาแนวคิดอย่าง Self, Shadow, Archetype และ Individuation ซึ่งเป็นเสาหลักของจิตวิทยาเชิงลึก",
    technicalMeaning:
...
เมื่อเผชิญกับมอนสเตอร์หรือความมืดในทะเลลึก บุคคลจะค่อย ๆ ค้นพบส่วนที่ขาดหายไปของตัวเอง (เช่น Shadow หรือ Anima/Animus) และนำมันกลับมาผสมผสานเข้ากับจิตสำนึก ทำให้เกิดการเติบโตและการหลอมรวมเข้ากับ Self ในที่สุด`,
...

  {
    ...
    shortDescription: "ทำความเข้าใจแนวคิดแบบฉบับดั้งเดิม (Archetype) และความสำคัญของการรู้เท่าทันโครงสร้างร่วมทางจิตที่คอยกำหนดพฤติกรรมและการรับรู้ของเรา",
    framework: "Analytical Psychology",
    difficulty: "beginner",
...
ยุงเน้นย้ำว่า Archetype ไม่ใช่ภาพที่ถูกโปรแกรมไว้ล่วงหน้าในสมอง แต่เป็น **โครงสร้างที่ไม่มีเนื้อหา** คล้ายกับร่องน้ำที่รอให้น้ำ (ประสบการณ์ชีวิตส่วนบุคคล) ไหลผ่านและจัดรูปตามร่องนั้น
...
เมื่อเราตกอยู่ภายใต้อิทธิพลของ Archetype ใดอย่างรุนแรง (เช่น Hero หรือ Persona) เราจะแสดงพฤติกรรมตามทิศทางของแบบแผนนั้นโดยไม่รู้ตัว การตระหนักรู้เท่าทันจะช่วยให้เรามีอิสระจากการถูกครอบงำและปรับความสัมพันธ์กับชีวิตภายในได้ดียิ่งขึ้น`,
...

  {
    ...
    shortDescription: "ข้อมูลราคาค่าบริการและกิจกรรมพิเศษของหน้า Guide",
    relatedConcepts: [],
    references: [],
    bodyMarkdown: JSON.stringify({
      standard: {
        ...
        includedItems: [
          { bold: "เซสชันสัมภาษณ์ออนไลน์ 90 นาที", detail: "แบบส่วนตัว 1-on-1 ผ่าน Video Conference" },
          { bold: "รายงานสรุปรายบุคคล 2–3 หน้า", detail: "จัดส่งผ่าน PDF และบันทึกใน Client Portal" },
          { bold: "วิเคราะห์ Function Stack & Stress Loop", detail: "เพื่อการตระหนักรู้และนำไปพัฒนาต่อ" },
          { bold: "เปิดพื้นที่ติดตามผล", detail: "สอบถามข้อสงสัยเพิ่มเติมหลังอ่านรายงานได้โดยตรง" },
        ],
        cta: "จองคิวนัดหมาย (Book Session)",
        footer: "ไม่มีค่าใช้จ่ายแฝงใดๆ ทั้งสิ้น · ชำระเงินผ่าน PromptPay หรือโอนธนาคารเมื่อจองสำเร็จ",
      },
      specialEvent: {
        badge: "SPECIAL EVENT",
        ...
        description: "ในโอกาสครบรอบการรีแบรนด์ครั้งสำคัญจากชื่อเดิม <strong>The Soul's Compass - Moonlight</strong> สู่บ้านหลังใหม่ในนาม <strong>Archron</strong> เราเปิดรับสิทธิ์วิเคราะห์และสัมภาษณ์ฟรีสำหรับผู้ร่วมกิจกรรมครบถ้วนตามเงื่อนไขดังนี้:",
        conditions: [
          { step: "1", text: "อวยพรวันเกิดเพจในโพสต์กิจกรรมหลักประจำวันที่ <strong>16 กรกฎาคม 2569</strong>" },
          { step: "2", text: "แชร์โพสต์โปรโมตกิจกรรมการรีแบรนด์ไปยังโปรไฟล์ส่วนตัวของคุณพร้อมเปิดสาธารณะ" },
          { step: "3", text: "ตกลงส่งรีวิวสะท้อนผลการสัมภาษณ์ตามความเป็นจริงผ่านหน้าเพจ Archron หลังเสร็จสิ้นเซสชัน" },
        ],
